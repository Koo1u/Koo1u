...
kable(tbl_2, digits = 2, format = "html", booktabs=TRUE, ,caption = "Top 3 MPG Performing Cars: 1999, 2008") %>%
...
gridExtra::grid.arrange(q,w,ncol=1)
##esquisser(mpg)
...
gridExtra::grid.arrange(e,r,ncol=1)
```
